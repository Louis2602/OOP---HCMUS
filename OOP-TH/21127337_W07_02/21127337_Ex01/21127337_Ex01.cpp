...
int main()
{
    ...
    oe3.Output();
    cout.setf(ios::fixed);
    cout << setprecision(0) << "Office Employee 3 salary is: " << oe3.Salary() << endl;

    OfficeEmployee oe4(12, "Bui Minh", 30);
    oe3.Output();
    cout.setf(ios::fixed);
    cout << setprecision(0) << "Office Employee 3 salary is: " << oe4.Salary() << endl;

    OfficeEmployee oe5(12, "Tran Kha", "101 Duong so 7", 30);
    oe5.Output();
    cout.setf(ios::fixed);
    cout << setprecision(0) << "Office Employee 5 salary is: " << oe5.Salary() << endl;
    ...
    Worker w3(13, 50);
    w3.Output();
    cout << setprecision(0) << "Worker 3 salary is: " << w3.Salary() << endl;

    Worker w4(13, "Ngan Lam", 123);
    w4.Output();
    cout << setprecision(0) << "Worker 4 salary is: " << w4.Salary() << endl;

    Worker w5(13, "Kim", "2012/12/3 Tran Hung Dao", 156);
    w5.Output();
    cout << setprecision(0) << "Worker 5 salary is: " << w5.Salary() << endl;
