...
private:
    ...
    // use this when you want to access to private variables from the outer child class
protected:
    string Name;
...
public:
    ...
    // Khi goi toi ham ao, thi se check coi class con co implementation cua ham nay hay khong, neu co thi goi toi ham con do.
    virtual void Work()
    {
